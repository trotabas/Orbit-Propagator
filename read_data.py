...
# =============================================================================
path = "Output/"
df = pd.read_csv(path + 'test.csv', delim_whitespace=True)#, header=None)#, delimiter=None)
...
# Figure
# =============================================================================
fig, ax = plt.subplots( figsize = (1.25*3.37,1.25*3.37))
plt.gcf().subplots_adjust(right = 0.99, left = 0.125, wspace = 0.225, top = 0.99, hspace = 0.35, bottom = 0.1 )
#-->
x=data_h*np.cos(data_theta)
y=data_h*np.sin(data_theta)
#-->
x_earth=r_earth*np.cos(np.linspace(0,2.0*np.pi,100))*1e-3
y_earth=r_earth*np.sin(np.linspace(0,2.0*np.pi,100))*1e-3
#-->
ax.plot(x/r_earth, y/r_earth, color = "forestgreen", label = r'$\textrm{Trajectory polar}$')
ax.plot(x_earth/r_earth, y_earth/r_earth, color = "blue", label = r'$\textrm{Earth surface}$')
ax.plot(x[0]/r_earth, y[0]/r_earth,'*', color = "red", label = r'$\textrm{Start}$')
ax.plot(x[-1]/r_earth, y[-1]/r_earth,'+', color = "green", label = r'$\textrm{Stop}$')
...
plt.gcf().subplots_adjust(right = 0.85, left = 0.15, wspace = 0.225, top = 0.98, hspace = 0.35, bottom = 0.135 )
ax.plot(data_time/(24*3600), data_h-r_earth*1e-3, color = "forestgreen", label = r'$h$ $(\mathrm{km})$')
ax.legend(loc=0, frameon = False)
# ax.set_xlim([-0.05, 1])
# ax.set_ylim([150, 500])
ax.set_xlabel(r'$\textrm{Day in orbit}$') 
ax.set_ylabel(r'$\textrm{Altitude evolution}$ $(\mathrm{km})$') 
...
y_earth=r_earth*np.sin(np.linspace(0,2.0*np.pi,100))*1e-3
#-->
ax00.plot(x/r_earth, y/r_earth, color = "forestgreen", label = r'$\textrm{Trajectory polar}$')
ax00.plot(x_earth/r_earth, y_earth/r_earth, color = "blue", label = r'$\textrm{Earth surface}$')
ax00.plot(x[0]/r_earth, y[0]/r_earth,'*', color = "red", label = r'$\textrm{Start}$')
ax00.plot(x[-1]/r_earth, y[-1]/r_earth,'+', color = "green", label = r'$\textrm{Stop}$')
